        ...
        <div className="dash-subs">
            <div className="filters">
                <div className="search">
                    ...
                    <input type="text" placeholder="Search Agencies...." onChange={(e) => setSearch(e.target.value)} />
                </div>
            </div>
            <div className="table-container">
                <table>
                    ...
                    <tbody>
                        {agencies.filter((agency) => agency.name.toLowerCase().includes(search.toLowerCase())).map((agency) => (
                            <tr key={agency.id}>
                                <td>{agency.name}</td>
